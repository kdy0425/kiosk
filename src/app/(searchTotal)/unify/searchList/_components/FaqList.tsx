...
const FaqList = ({faq, loading, handleSelected}: Props) => {
    ...
    return (
        <div className="search-section" style={{border: "none", paddingTop: 0}}>
            <div className="section-title">
                <h1 className="page-title">자주하는 질문<span className="result-total">[검색결과 {getCommaNumber(searchCategory.faqTotalCount)}건]</span></h1>
            </div>
            {!loading ? (
