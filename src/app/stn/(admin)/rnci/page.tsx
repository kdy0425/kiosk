...
import { hisstnrnciheadCells, stnrnciheadCells } from '@/utils/fsms/headCells'
  ...
  return (
    <TableHead>
      ...
      <TableRow>
        ...
        <TableCell style={{ whiteSpace: 'nowrap' }}>영치등록구분</TableCell>
        <TableCell style={{ whiteSpace: 'nowrap' }}>영치등록사유</TableCell>
...
const DataList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let endpoint: string =
        `/fsm/stn/rnci/tr/regNopltCsdyInfo?page=${params.page}&size=${params.size}` +
  ...
  const excelDownload = async () => {
    ...
    let endpoint: string =
      `/fsm/stn/rnci/tr/getExcelRegNopltCsdyInfo?` +
      `${params.locgovCd ? '&locgovCd=' + params.locgovCd : ''}` +
      `${params.vhclNo ? '&vhclNo=' + params.vhclNo : ''}`
      ...
      <>
        {selectedRow ? (
          <>
            ...
            <BlankCard title="등록번호판영치정보 이력">
            <TableDataGrid
              headCells={hisstnrnciheadCells}
