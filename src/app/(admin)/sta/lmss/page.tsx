...
import { arSA } from '@mui/material/locale'
  ...
  const DataList = () => {
        ...
        return (
          <TableHead>
            <TableRow>
              ...
              <TableCell 
                rowSpan={2} colSpan={2} style={{ whiteSpace: "nowrap" }}>
                상태
              </TableCell>
              <TableCell rowSpan={2} style={{ whiteSpace: "nowrap" }}>
                합계
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        let endpoint: string =
          `/fsm/sta/lmss/getAllLocgovMvmvSttusSm?` +
  ...
  //   }
    ...
    return (
      <PageContainer
        title="지자체 전출입현황 집계"
        description="지자체 전출입현황 집계"
      >
        {/* breadcrumb */}
        <Breadcrumb title="지자체 전출입현황 집계" items={BCrumb} />
        {/* end breadcrumb */}
