              ...
              <table className="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {brNoFormatter(detail['brno'] ? detail['brno'] : '')}
                    </td>
                    <th className="td-head" scope="row">
                      주민등록번호
                    </th>
                    <td>
                      {rrNoFormatter(detail['rrnoS'] ? detail['rrnoS'] : '')}
                    </td>
                  </tr>
                  <tr>
                    <th className="td-head" scope="row">
                    ...
                    <td>{detail['vhclSeCdNm']}</td>
                    <th className="td-head" scope="row">
                      유종
                    </th>
                    <td>{detail['koiCdNm']}</td>
                  </tr>
                  <tr>
                    <th className="td-head" scope="row">
                      카드사
                  ...
                  <tr>
                    ...
                    <td>{detail['aprvYnNm']}</td>
                    <th className="td-head" scope="row">
                      처리일자
                    </th>
                    <td>{formatDate(detail['aprvYmd'])}</td>
                  ...
                  <tr>
                    ...
                    <td colSpan={3}>{detail['rejectType']}</td>
                    <th className="td-head" scope="row">
                      탈락사유
                    </th>
                    <td colSpan={3}>{detail['etcCn']}</td>
                  </tr>
                  <tr>
                    <th className="td-head" scope="row">
                      등록자아이디
