...
const DataList = () => {
  ...
  const [selectedIndex, setSelectedIndex] = useState<number>(-1); // 선택된 로우 데이터
  const [selectedRow, setSelectedRow] = useState<Row|null>(null); // 선택된 로우 데이터
      ...
      <Box sx={{ mb: 2 }}>
        <Box className="sch-filter-box">
          <div className="filter-form">
            ...
            <div className="form-group">
              <CustomFormLabel className="input-label-display" htmlFor="ft-vhcl-no">
                차량번호
              </CustomFormLabel>
              <CustomTextField type="text" id="ft-vhcl-no" name="vhclNo" value={params.vhclNo} onChange={handleSearchChange} onKeyDown={handleKeyDown} fullWidth />
            </div>
            <div className="form-group">
              <CustomFormLabel className="input-label-display" htmlFor="ft-vonr-nm">
                소유자명
              </CustomFormLabel>
              <CustomTextField type="text" id="ft-vonr-nm" name="vonrNm" value={params.vonrNm} onChange={handleSearchChange} onKeyDown={handleKeyDown} fullWidth />
            </div>
          </div><hr></hr>
          <div className="filter-form">
          <div className="form-group">
        ...
        <Box className="table-bottom-button-group">
          <div className="button-right-align">
            <Button onClick={handleAdvancedSearch} variant="contained" color="primary">
              검색
            </Button>
          </div>
        </Box>
