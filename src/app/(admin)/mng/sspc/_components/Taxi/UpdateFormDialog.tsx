...
const FormDialog: React.FC<FormDialogProps> = ({ buttonLabel, title, size, detail, reload }) => {
    ...
    useEffect(() => {
        setParams({
            bgngYmd: formatDate(detail?.['bgngYmd']),
            endYmd: formatDate(detail?.['endYmd']),
        })
    }, [detail])
    ...
    const modifyData = async (detail?: Row) => {
        ...
        try {
            ...
            let endpoint: string = '/fsm/mng/sspc/tx/updateSbsidyStopPymntChmngmt'
        ...
        <DialogContent>
            <Box className="table-bottom-button-group">
                ...
                <div className="button-right-align">
                    <Button color="primary" onClick={() => modifyData(detail)}>저장</Button>
                    <Button color="dark" onClick={handleClose}>취소</Button>
                </div>
            </Box>
            <Box 
                sx={{ 
                    ...
                    <table className="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <CustomTextField type="date" id="bgngYmd" name="bgngYmd" value={params.bgngYmd} onChange={handleDateChange} fullWidth />
                                </td>
                                <th className="td-head" scope="row">지급정지종료일</th>
                                <td>
                                    <CustomTextField type="date" id="endYmd" name="endYmd" value={params.endYmd} onChange={handleDateChange} fullWidth />
                                </td>
