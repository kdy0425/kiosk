        ...
        >
          <TableBody>
            <TableRow>
              ...
              >
                <CustomFormLabel
                  ...
                  htmlFor="modal-select-leadCnCd"
                >
                  구분
                </CustomFormLabel>
                {!isEditMode ? (
                  leadCnCode.find(
                    (option) => option.value === formData.leadCnCd,
                  )?.label || '-' // label 값 표시
                ) : (
                  <select
              ...
              >
                <CustomFormLabel
                  className="input-label-none"
                  htmlFor="modal-select-relateTaskSeCd"
                >
                  구분
                </CustomFormLabel>
                {!isEditMode ? (
                  relateTaskSeCode.find(
                    (option) => option.value === formData.relateTaskSeCd,
                  )?.label || '-' // label 값 표시
                ) : (
                  <select
                    className="custom-default-select"
            ...
            <TableRow>
              ...
              <TableCell colSpan={3}>
                <CustomFormLabel className="input-label-none" htmlFor="files">
                  첨부파일
                </CustomFormLabel>
                {isEditMode && (
                  <input
