...
interface TxSbsidyQflyErsrModalProps {
  open: boolean
...
const TxSbsidyQflyErsrModal = (props: TxSbsidyQflyErsrModalProps) => {
  const { open, handleClickClose, row, cardRow, reload } = props
  ...
  const saveData = async () => {
    ...
    if (dscntChgAplcnYmdValidation()) {
      ...
      if (!confirm('해당 차량의 카드에 대해 보조금수급자격 말소를 진행하시겠습니까?'))
        return

      let endpoint: string = `/fsm/stn/vem/tx/updateSbsidyQflyErsrMng`
...
export default TxSbsidyQflyErsrModal
