...
import { symTrccHC } from '@/utils/fsms/headCells'
...
const DataList = () => {
  ...
  symTrccHC[0].button = {
    ...
    onClick: async (row:Row, event: any) => {
      ...
      let endpoint : string = `/fsm/sym/trcc/tr/excuteTruckCardCntc?procNm=${row.procNm}`;
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let endpoint: string =
        `/fsm/sym/trcc/tr/getAllTruckCardCntc?page=${params.page}&size=${params.size}` +
