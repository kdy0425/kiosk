                  ...
                  rows.length > 0 ? rows.map((row: any, index) => {
                    return (
                      <TableRow 
                        ...
                        <TableCell style={{whiteSpace:'nowrap'}}>{row.giveCfmtnYn === 'Y' ? '확정' : '미확정'}</TableCell>
                        <TableCell style={{whiteSpace:'nowrap'}}>{row.giveCfmtnYn === 'Y' ? row.giveCtmtnTm : ''}</TableCell>
                        <TableCell style={{whiteSpace:'nowrap'}}>{row.vhclNo}</TableCell>
                      </TableRow>
                    )
                  }) : 
                  <TableRow key={'tr0'}>
                    <TableCell colSpan={19} className='td-center'><p>자료가 없습니다. 다른 검색조건을 선택해주세요.</p></TableCell>
                  </TableRow>
                : 
                <TableRow key={'tr0'}>
                  <TableCell colSpan={19} className='td-center'><p> </p></TableCell>
                </TableRow>
              }
          </TableBody>
          </table>
