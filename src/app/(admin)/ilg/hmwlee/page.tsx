...
// headCells
import { ilgHmwleeDoubtTransTxHC } from '@/utils/fsms/headCells' // 의심거래내역 탭 그리드
import { ilgHmwleeExamTargetTxHC } from '@/utils/fsms/headCells' // 조사대상내역 탭 그리드
      ...
      <div style={{ marginTop: '-8px' }}>
        <BlankCard>
          <Box display={selectedTab === '0' ? 'block' : 'none'} sx={{ mb: 2 }}>
            ...
            <TabDataGrid
              headCells={ilgHmwleeDoubtTransTxHC} // 테이블 헤더 값
              rows={tabRows} // 목록 데이터
          ...
          <Box display={selectedTab === '1' ? 'block' : 'none'} sx={{ mb: 2 }}>
            ...
            <TabDataGrid
              headCells={ilgHmwleeExamTargetTxHC} // 테이블 헤더 값
              rows={tabRows} // 목록 데이터
              totalRows={tabTotalRows} // 총 로우 수
              loading={loading} // 로딩여부
              onPaginationModelChange={handlePaginationModelChange} // 페이지 , 사이즈 변경 핸들러 추가
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell style={{ textAlign: 'left' }}>
                            <CustomFormLabel className="input-label-none" htmlFor="trnsfRsnCn">내용</CustomFormLabel>
