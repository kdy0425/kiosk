...
const BsDetail: React.FC<DetailDataGridProps> = ({
  row,
}) => {
            ...
            <table className="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    {getDateTimeString(row.stopBgngYmd, 'date')?.dateString}
                  </td>
                  <th className="td-head" scope="row">
                  지급 정지 종료일
                  </th>
                  <td>
                    {getDateTimeString(row.stopEndYmd, 'date')?.dateString}
                  </td>
                  <th className="td-head" scope="row">
                  </th>
                  <td>
                ...
                <tr>
                  ...
                  <td colSpan={7} style={{whiteSpace: 'pre-wrap', height:'100px'}}> 
                    {row?.stopRsnCn}
                  </td>
                </tr>
                <tr>
