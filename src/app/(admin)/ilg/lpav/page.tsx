...
const DataList = () => {
  ...
  const returnHeadCell = (tabValue: string): HeadCell[] => {
    return lpavTabHeadCells[Number(tabValue) - 1]
  }
  ...
  return (
    <PageContainer title="주유패턴이상차량" description="주유패턴이상차량">
      {/* breadcrumb */}
      <Breadcrumb title="주유패턴이상차량" items={BCrumb} />
      {/* end breadcrumb */}
