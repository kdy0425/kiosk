...
const DataList = () => {
  ...
  useEffect(() => {
    if (dvhalInfo.dvhalSearchDone || flag) {
      fetchData()
    }
  }, [dvhalInfo.dvhalSearchDone, flag])
  ...
  const returnHeadCell = (tabValue: string): HeadCell[] => {
    return dvhalTabHeadCells[Number(tabValue) - 1]
  }
