...
<style>
.qna_caution{background-color:#f1f1f1;padding:20px;font-size:20px;color:#222;text-align:center;letter-spacing:-0.5px;margin-bottom:25px;word-break:keep-all;}
.qna_caution strong{color:#0261A4;font-size:24px;}
.qna_layer{position:fixed;left:50%;top:50%;transform:translate(-50%,-50%);border:1px solid #ddd;z-index:100;word-break:keep-all;box-shadow:0 0 15px rgba(0,0,0,.15);}
.qna_layer .cnt{padding:60px 35px;font-size:18px;color:#222;text-align:center;letter-spacing:-0.5px;line-height:1.6;background-color:#fff;}
.qna_layer .cnt strong{color:#0261A4;font-size:22px;font-weight:600;}
.qna_layer button{width:100%;border:0;background-color:#0261A4;color:#fff;font-size:17px;font-weight:600;height:50px;}
</style>
<div class="qna_caution">
	바쁜 업무로 인해 인터넷 문의는 답변이 느릴 수 있습니다.<br/>
	빠른 상담을 원하시면 <strong>02-6953-8405, 010-8253-8882</strong>로 <br/>연락 주시면 친절하게 상담 도와드리겠습니다.
</div>
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
			  ...
			  <input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input required" size="10" maxlength="20"></td>
        </tr>
        <?php } ?>
        ...
        <tr>
		 ...
		 <tr>
            ...
            <td><input type='text' name='wr_1' value='<?=$write[wr_1]?>' required class="frm_input required" placeholder="ex) 010-1234-1234" size="25"></td>
        </tr>
		 <tr>
            <th scope="row"><label for="wr_email">차종,연식<span class="required_txt">(필수)</span></label></th>
            <td><input type='text' name='wr_2' value='<?=$write[wr_2]?>' required class="frm_input required" placeholder="ex) 쏘나타 2012년식"size="25"></td>
        </tr>
        <tr>
