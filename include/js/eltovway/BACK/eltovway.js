    ...
    loadPubArea() {
        ...
        let pubAreaHtml = `
            <div class="floor_pub_area">
                ...
                <button id="currentBtn" style="display: none;">
            ...
            let pubHtml = `
                <li>
                    <button data-pub-code="${pub.PUB_CODE}">
                        <img src="${pub.PUB_URL}" alt="${pub.PUB_NAME}" >${pub.PUB_NAME}
                    </button>
                </li>
            `;
